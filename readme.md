...
- **Semantic syntax highlighting** — full LSP semantic tokens provider with delta updates. Every identifier gets the right color: types, procedures, variables, keywords, operators, constants. Works inside `#run` directives, case bodies, and compound declarations.
